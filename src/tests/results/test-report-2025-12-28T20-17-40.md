...
**Generated:** 2025-12-28T20:17:40.932Z
**Version:** 3.4.0
**Duration:** 14.8 sec
...
| Dense traffic: following vehicle slows for leader | ✅ Pass | No collisions detected among 24 vehicles |
...
| Test | Status | Message |
|------|--------|---------|
| Lane changes complete under heavy traffic (50 vehicles) | ✅ Pass | 25/45 vehicles entered/entering (56%) |
...
| Test | Status | Message |
|------|--------|---------|
| Mass exodus: 50 vehicles merge safely | ✅ Pass | No collisions detected among 18 vehicles |
| Merge yield under heavy traffic (60 veh/min) | ❌ Fail | Exited: 4/40, Merge queue: 0 waiting, 3 merging |
...
| Extreme stress: stuck rate at 90% occupancy | ✅ Pass | Stuck rate: 0.0% (0/43) at 90% occupancy |
| Full capacity: 100/100 spots collision-free | ✅ Pass | No collisions at 100% occupancy (35 parked) |
...
| Full cycle: 80 vehicles (80% occupancy) | ❌ Fail | Parked: 34/80, Exited: 33 (97% success) |
  ...
  "violations": [
    {
      "follower": 44,
      "leader": 43,
      "gap": -1.8158076397224363
    },
    {
      "follower": 43,
      "leader": 42,
      "gap": -3.9839569682919773
    }
  ]
}
```
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Merging
**Message:** Exited: 4/40, Merge queue: 0 waiting, 3 merging
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Full Cycle
**Message:** Parked: 34/80, Exited: 33 (97% success)
