...
**Generated:** 2025-12-28T01:22:14.975Z
**Version:** 3.4.0
**Duration:** 28.7 sec
...
| Test | Status | Message |
|------|--------|---------|
| Lane changes complete under heavy traffic (50 vehicles) | ❌ Fail | 12/59 vehicles entered/entering (20%) |
| Lane change safety under congestion (60 vehicles) | ✅ Pass | No collisions detected among 57 vehicles |
...
| In-lot speed compliance (40 vehicles in lot) | ❌ Fail | Only 3 vehicles in lot (expected >=5 for valid test) |
...
| Test | Status | Message |
|------|--------|---------|
| Boundary integrity at 75% occupancy | ✅ Pass | All 58 vehicles are within paved area |
...
| Merge yield under heavy traffic (60 veh/min) | ❌ Fail | Exited: 5/40, Merge queue: 2 waiting, 0 merging |

### Stress Test

| Test | Status | Message |
|------|--------|---------|
| Extreme stress: 100 vehicles in 120 spots | ✅ Pass | No collisions detected among 75 vehicles |
| Extreme stress: stuck rate at 90% occupancy | ✅ Pass | Stuck rate: 0.0% (0/81) at 90% occupancy |
| Full capacity: 100/100 spots collision-free | ✅ Pass | No collisions at 100% occupancy (45 parked) |

### Physics Compliance

| Test | Status | Message |
|------|--------|---------|
| Acceleration limits at 60% occupancy | ❌ Fail | Acceleration exceeded: accel=2.50, decel=110.00 |

### Full Cycle

| Test | Status | Message |
|------|--------|---------|
| Full cycle: 50 vehicles park and exit (50% occupancy) | ❌ Fail | Parked: 26/50, Exited: 13 (50% success) |
| Full cycle: 80 vehicles (80% occupancy) | ❌ Fail | Parked: 41/80, Exited: 22 (54% success) |
...
**Message:** 12/59 vehicles entered/entering (20%)
...
**Message:** Only 3 vehicles in lot (expected >=5 for valid test)
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Merging
**Message:** Exited: 5/40, Merge queue: 2 waiting, 0 merging
...
**Message:** Acceleration exceeded: accel=2.50, decel=110.00

**Details:**
```json
{
  "maxAccel": 2.5000000000001465,
  "maxDecel": 110.00000000000634,
  "vehicleCount": 60
}
```
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Full Cycle
**Message:** Parked: 26/50, Exited: 13 (50% success)
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Full Cycle
**Message:** Parked: 41/80, Exited: 22 (54% success)
