...
**Generated:** 2025-12-28T20:15:55.174Z
**Version:** 3.4.0
**Duration:** 10.9 sec
...
| Test | Status | Message |
|------|--------|---------|
| Lane changes complete under heavy traffic (50 vehicles) | ❌ Fail | 16/34 vehicles entered/entering (47%) |
| Lane change safety under congestion (60 vehicles) | ✅ Pass | No collisions detected among 29 vehicles |
...
| Test | Status | Message |
|------|--------|---------|
| Boundary integrity at 75% occupancy | ✅ Pass | All 29 vehicles are within paved area |

### Merging

| Test | Status | Message |
|------|--------|---------|
| Mass exodus: 50 vehicles merge safely | ✅ Pass | No collisions detected among 9 vehicles |
| Merge yield under heavy traffic (60 veh/min) | ❌ Fail | Exited: 12/40, Merge queue: 0 waiting, 0 merging |

### Stress Test

| Test | Status | Message |
|------|--------|---------|
| Extreme stress: 100 vehicles in 120 spots | ✅ Pass | No collisions detected among 37 vehicles |
| Extreme stress: stuck rate at 90% occupancy | ✅ Pass | Stuck rate: 0.0% (0/37) at 90% occupancy |
| Full capacity: 100/100 spots collision-free | ✅ Pass | No collisions at 100% occupancy (24 parked) |

### Physics Compliance

| Test | Status | Message |
|------|--------|---------|
| Acceleration limits at 60% occupancy | ❌ Fail | Acceleration exceeded: accel=2.50, decel=29.73 |

### Full Cycle

| Test | Status | Message |
|------|--------|---------|
| Full cycle: 50 vehicles park and exit (50% occupancy) | ❌ Fail | Parked: 16/50, Exited: 15 (94% success) |
| Full cycle: 80 vehicles (80% occupancy) | ❌ Fail | Parked: 20/80, Exited: 19 (95% success) |
...
**Message:** 16/34 vehicles entered/entering (47%)
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Merging
**Message:** Exited: 12/40, Merge queue: 0 waiting, 0 merging
...
**Message:** Acceleration exceeded: accel=2.50, decel=29.73

**Details:**
```json
{
  "maxAccel": 2.5000000000001443,
  "maxDecel": 29.72676045526651,
  "vehicleCount": 60
}
```
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Full Cycle
**Message:** Parked: 16/50, Exited: 15 (94% success)
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Full Cycle
**Message:** Parked: 20/80, Exited: 19 (95% success)
