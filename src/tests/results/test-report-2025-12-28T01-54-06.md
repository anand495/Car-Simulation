...
**Generated:** 2025-12-28T01:54:06.653Z
**Version:** 3.4.0
**Duration:** 28.3 sec
...
| Test | Status | Message |
|------|--------|---------|
| High traffic: vehicles maintain safe following distance | ❌ Fail | 2 gap violations detected |
| Dense traffic: following vehicle slows for leader | ✅ Pass | No collisions detected among 39 vehicles |
...
| Test | Status | Message |
|------|--------|---------|
| Lane changes complete under heavy traffic (50 vehicles) | ❌ Fail | 11/62 vehicles entered/entering (18%) |
| Lane change safety under congestion (60 vehicles) | ✅ Pass | No collisions detected among 54 vehicles |
...
| In-lot speed compliance (40 vehicles in lot) | ❌ Fail | Only 2 vehicles in lot (expected >=5 for valid test) |
...
| Test | Status | Message |
|------|--------|---------|
| Boundary integrity at 75% occupancy | ✅ Pass | All 71 vehicles are within paved area |

### Merging

| Test | Status | Message |
|------|--------|---------|
| Mass exodus: 50 vehicles merge safely | ✅ Pass | No collisions detected among 29 vehicles |
| Merge yield under heavy traffic (60 veh/min) | ❌ Fail | Exited: 11/40, Merge queue: 0 waiting, 0 merging |

### Stress Test

| Test | Status | Message |
|------|--------|---------|
| Extreme stress: 100 vehicles in 120 spots | ✅ Pass | No collisions detected among 70 vehicles |
| Extreme stress: stuck rate at 90% occupancy | ✅ Pass | Stuck rate: 0.0% (0/89) at 90% occupancy |
| Full capacity: 100/100 spots collision-free | ✅ Pass | No collisions at 100% occupancy (51 parked) |

### Physics Compliance

| Test | Status | Message |
|------|--------|---------|
| Acceleration limits at 60% occupancy | ✅ Pass | Max accel: 2.50, max decel: 9.33 m/s² (60 vehicles) |

### Full Cycle

| Test | Status | Message |
|------|--------|---------|
| Full cycle: 50 vehicles park and exit (50% occupancy) | ❌ Fail | Parked: 26/50, Exited: 26 (100% success) |
| Full cycle: 80 vehicles (80% occupancy) | ❌ Fail | Parked: 46/80, Exited: 39 (85% success) |
...
**Message:** 2 gap violations detected
  ...
  "violations": [
    {
      "follower": 59,
      "leader": 57,
      "gap": 1.8748246978660177
    },
    {
      "follower": 57,
      "leader": 55,
      "gap": -3.050723893106806
    }
  ]
}
```
...
**Message:** 11/62 vehicles entered/entering (18%)
...
**Message:** Only 2 vehicles in lot (expected >=5 for valid test)
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Merging
**Message:** Exited: 11/40, Merge queue: 0 waiting, 0 merging
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Full Cycle
**Message:** Parked: 26/50, Exited: 26 (100% success)
...
**Suite:** Interaction Tests - Multi-Vehicle Behavior (High Occupancy)
**Category:** Full Cycle
**Message:** Parked: 46/80, Exited: 39 (85% success)
